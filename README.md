...
**Certificates**
1. Linkedin Learning [Introducing Jupyter](Course-Certificates/CertificateOfCompletion_Introducing Jupyter.pdf)
2. PYnative  [Bsic Python Quiz For Beginners]
3. PYnative [Python Functions Quiz]
4. PYnative [Python List Quiz]
5. PYnative [Python Operators and Expression Quiz]
6. W3 Schools [Pythin Quiz]
